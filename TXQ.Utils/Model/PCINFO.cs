...
namespace TXQ.Utils.Model
{
    public class PCINFO
    {
        ...
        public void Init()
        {
            ...
            //Task[] T =
            //     {
            //        Task.Factory.StartNew(InitCPUInfo),
            //        Task.Factory.StartNew(InitDiskInfo),
            //        Task.Factory.StartNew(InitDVDInfo),
            //        Task.Factory.StartNew(InitMonitorInfo),
            //        Task.Factory.StartNew(InitBaseboardInfo),
            //        Task.Factory.StartNew(InitSystemInfo),
            //        Task.Factory.StartNew(InitNetWorkInfo),
            //        Task.Factory.StartNew(InitMemoryInfo),
            //        Task.Factory.StartNew(InitGPUInfo),
            //        Task.Factory.StartNew(InitBiosInfo)
            //    };
            //Task.WaitAll(T);
            InitCPUInfo();
            InitDiskInfo();
