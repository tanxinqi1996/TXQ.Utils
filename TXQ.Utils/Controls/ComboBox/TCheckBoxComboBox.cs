...
namespace TXQ.Utils.Controls
{
    ...
    /// </summary>
    public partial class TCheckBoxComboBox : PopupComboBox
    {
        #region CONSTRUCTOR
        ...
        {
            CheckBoxComboBoxItem item = sender as CheckBoxComboBoxItem;
            if (item.Text.Contains("全选"))
            {
                foreach (CheckBoxComboBoxItem boxItem in this.CheckBoxItems)
                {
                    boxItem.CheckState = item.CheckState;
                }
            }
        }
        ...
        internal string GetCSVText(bool skipFirstItem)
        {
            ...
            return ListText.Replace("全选,", null);
        }
        ...
        public CheckBoxProperties CheckBoxProperties
        {
            ...
            set { _CheckBoxProperties = value; CheckBoxProperties_PropertyChanged(this, EventArgs.Empty); }
        }
    ...
    public class CheckBoxComboBoxListControl : ScrollableControl
    {
        ...
        public CheckBoxComboBoxListControl(TCheckBoxComboBox owner)
            : base()
        {
            DoubleBuffered = true;
        ...
        /// </summary>
        private TCheckBoxComboBox _CheckBoxComboBox;
        /// <summary>
    ...
    public class CheckBoxComboBoxItem : CheckBox
    {
        ...
        public CheckBoxComboBoxItem(TCheckBoxComboBox owner, object comboBoxItem)
            : base()
        {
            DoubleBuffered = true;
            _CheckBoxComboBox = owner;
    ...
    public class CheckBoxComboBoxItemList : List<CheckBoxComboBoxItem>
    {
        ...
        public CheckBoxComboBoxItemList(TCheckBoxComboBox checkBoxComboBox)
        {
